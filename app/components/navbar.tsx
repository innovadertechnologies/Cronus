...
const navLinks = [
  ...
  { label: "Why Cronus", href: "#why-cronus" },
  { label: "Laparoscopy", href: "#laparoscopy" },
  { label: "Types of Hernia", href: "#hernia-types" },
  { label: "FAQs", href: "#faq" },
];
    ...
    >
      ...
      >
        ...
        <button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-lg text-[#005F70] lg:hidden"
        >
