  ...
  return (
    <section id="why-choose" className="scroll-mt-24 bg-white">
      <div className="mx-auto max-w-7xl px-5 py-16 text-center sm:px-8 sm:py-20">
        ...
        <Reveal delay={0.15}>
          <BookTrigger className="group mt-12 inline-flex items-center justify-center gap-2 rounded-xl bg-[#0B3446] px-7 py-3.5 text-base font-semibold text-white shadow-[0_14px_28px_-10px_rgba(11,52,70,0.5)] transition-all hover:brightness-105">
