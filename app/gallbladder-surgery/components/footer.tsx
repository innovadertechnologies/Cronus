    ...
    <footer className="border-t border-white/10 bg-[#005F70] pb-24 pt-12 sm:pb-12">
      <div className="mx-auto flex max-w-7xl flex-col gap-8 px-5 sm:px-8 md:flex-row md:items-start md:justify-between">
        ...
        <div className="hidden shrink-0 flex-col gap-2.5 sm:flex">
          <a
            href={`tel:${CLINIC_PHONE_TEL}`}
            className="flex items-center justify-center gap-2 rounded-xl border border-white/20 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:border-white/40"
          >
            <Phone className="h-4 w-4" />
            Call Now
          </a>
