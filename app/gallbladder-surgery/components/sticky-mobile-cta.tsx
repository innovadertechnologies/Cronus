  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 flex border-t border-slate-200 bg-white/95 shadow-[0_-8px_24px_-16px_rgba(11,31,51,0.3)] backdrop-blur sm:hidden">
      <a
        ...
        className="flex flex-1 items-center justify-center gap-2 py-3.5 text-sm font-semibold text-[#0B3446]"
      >
        <Phone className="h-4 w-4" />
        Call Now
      </a>
      <BookTrigger className="flex flex-1 items-center justify-center gap-2 bg-[#0B3446] py-3.5 text-sm font-semibold text-white">
