...
const links = [
  ...
  { label: "Meet the Specialist", href: "#specialist" },
  { label: "FAQ", href: "#faq" },
...
export function Footer() {
  return (
    <footer className="border-t border-slate-200 bg-white pb-28 pt-12 lg:pb-12">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-8 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <p className="mt-3 max-w-xs text-sm leading-relaxed text-[#64748B]">
            Expert evaluation and personalized treatment for back pain, sciatica and spine conditions by Dr. Sandeep
            Singh in {CLINIC_LOCATION}.
          </p>
        </div>
